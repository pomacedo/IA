...
/**
 * @author Miguel Tavares, Pedro Gaspar, Modified by Pedro Macedo and João Duro
 * 
 */
public class Simulator extends SimState{
	...
	public final static int limitRadius = (int) (Math.max(WIDTH, HEIGHT) * 0.7);	// The 0.25 should be RAIUS_RATIO or something
